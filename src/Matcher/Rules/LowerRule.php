...
class LowerRule extends AbstractRule implements ComparisonRule
{
    /**
     * @var string
     */
    ...
    public function assertMatch($test): void
    {
        ...
        if (!($test < $this->value)) {
            throw new Mismatches\ValueMismatch('Value {{ actual }} should be lower than {{ expected }}', $this->value, $test);
        }
    }
